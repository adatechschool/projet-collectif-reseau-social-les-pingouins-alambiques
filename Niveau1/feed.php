...
<body>
    ...
    <div id="wrapper">
        ...
        <aside>
            ...
            <section>
                <h3>Présentation</h3>
                <p>Sur cette page vous trouverez tous les messages des utilisateurices
                    auxquel.les est abonnée l'utilisateurice
                    <?php echo $user['alias'] ?>
                    (n°
                    <?php echo $userId ?>)
                </p>
        ...
        <main>
            ...
            $laQuestionEnSql = "
                    ...
                    GROUP_CONCAT(DISTINCT tags.label SEPARATOR '#') AS taglist 
                    FROM followers 
